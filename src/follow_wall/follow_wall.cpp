...
void FollowWallNode::LaserCallback(
...
CallbackReturnT FollowWallNode::on_configure(
...
CallbackReturnT FollowWallNode::on_activate(
    const rclcpp_lifecycle::State &state) {
...
CallbackReturnT FollowWallNode::on_deactivate(
    const rclcpp_lifecycle::State &state) {
...
CallbackReturnT FollowWallNode::on_cleanup(
    const rclcpp_lifecycle::State &state) {
...
CallbackReturnT FollowWallNode::on_shutdown(
    const rclcpp_lifecycle::State &state) {
